...
#you can choose a frequency which you want to check
     ...
     debugg(f'index_of_frequncy {index_of_frequency}')
...
plt.plot(t[index_of_max], data_in_ db[index_of_max], 'go')
...
value of max less_25 = find_nearest_value(sliced_array, value_of_max_less_25)

index_of_max_less_25 = np.where(data_in_db == value_of_max_less_25)

plt.plot(t[index_of_max_less_25], data_in_db[index_of_max_less_251, 'ro') rt20 (t/index_of_max_less_5]t[index_of_max_less_25])[0]
#extrapolate rt20 to rt60
rt60 = 3*rt20
#optional set limits on plat
